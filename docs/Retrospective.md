...
* Communicate more effectively among teammembers.
* Dedicate time to changing how the UI works.
* More frequent documentation, ensuring all team members are documenting well on GitHub.
* Cleaning up code, commenting more often.
* Manage time better as a team and as each individual within the team.
